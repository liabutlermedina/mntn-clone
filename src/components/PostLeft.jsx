...
export default () => {
  return (
    <>
      <div className='max-w-6xl mx-auto relative mt-52 md:mt-96 lg:mt-[450px] xl:mt-[650px] text-white'>
        <div className='flex md:flex-row flex-col'>
          <div className='flex-1 md:py-10 xl:py-36 px-4 md:px-20 relative'>
            ...
            <div className='flex items-center gap-6'>
              ...
              <p className='text-yellow-300 text-xs lg:text-sm xl:text-base font-semibold'>GET STARTED</p>
            </div>
          ...
          <img src={first} alt='' className='object-cover md:w-64 h-40 md:object-center object-bottom md:h-full lg:w-96 xl:w-[490px]' />
        </div>
      </div>
    </>
  )
